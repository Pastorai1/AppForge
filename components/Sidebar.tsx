...
const NAV = [
  ...
  { href: "/dashboard/staff", label: "Chief of Staff" },
  ...
  { href: "/dashboard/presentations", label: "One-to-Many Presentations" },
  { href: "/dashboard/frameworks", label: "Framework Extractor" },
